...
object MenuMealsRepo {
    private val menuMeals: List<Meal> = listOf(
    ...
    fun getMealAt(index: Int) = menuMeals[index]

    fun getMealByNumber(number: Int) = menuMeals.find { it.number == number }

    fun getAllMenuMeals() = menuMeals.toMutableList()
